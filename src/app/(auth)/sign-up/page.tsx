...
import { Scissors, ArrowLeft, UserPlus } from "lucide-react";
        ...
        <div className="w-full max-w-md">
          <Card className="border border-white/10 bg-white/5 backdrop-blur-sm shadow-xl">
            <CardHeader className="space-y-4 text-center">
              ...
              <div>
                <CardTitle className="text-2xl font-semibold text-white">Join ClipTidy</CardTitle>
                <CardDescription className="text-gray-400 mt-2">
                  Create your account and start converting videos to vertical format
                </CardDescription>
              </div>
            </CardHeader>
            <CardContent>
